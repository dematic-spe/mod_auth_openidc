...
del target\mod_auth_openidc-2.4.19-win64-VS16.zip
...
powershell -NoLogo -NoProfile -NonInteractive -Command "$ProgressPreference='SilentlyContinue'; Compress-Archive -Path 'target\\x64\\libcrypto-3-x64.dll' -Update -DestinationPath 'target\\mod_auth_openidc-2.4.19-win64-VS16.zip'"
powershell -NoLogo -NoProfile -NonInteractive -Command "$ProgressPreference='SilentlyContinue'; Compress-Archive -Path 'target\\mod_auth_openidc\\x64\\Release\\mod_auth_openidc.dll' -Update -DestinationPath 'target\\mod_auth_openidc-2.4.19-win64-VS16.zip'"
